...
<div class="main-container" style="min-height:100%">
    ...
    <div class="card-box mb-30">
      <div class="pd-20">
        <h4 class="text-dark h4"><i class="icon-copy dw dw-newspaper"></i> Setting Email</h4>
        <?php echo anchor(site_url('setting/create'), '<i class="icon-copy dw dw-add-file-1"></i> Add New','class="btn btn-primary"'); ?>
        </div>
    <div class="pb-20">
    ...
    <tbody></tbody>
                          ...
                          dataTable = $('#example1').DataTable({
                              ...
                              "ajax": {
                                url: "<?php echo site_url('setting/fetch_data'); ?>",
                                type: "POST",
                                dataSrc: "data",
                                data: function(d) {
                                  return d;
