				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-dark">REGISTER TO<br> RKG DIGITAL INDONESIA</h2>
						</div>
						
						<form method="POST" action="#" class="needs-validation" novalidate="" id="clientForm">
							<form accept-charset="UTF-8" role="form" class="form-signin">
								<div class="input-group custom">
									<input type="text" class="form-control form-control-lg" name="nama" required placeholder="Nama">
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="font-16 weight-600 pt-10 pb-10 text-center" data-color="#707373">Sudah Punya Akun?</div>
										<div class="input-group mb-0">
											<a class="btn btn-outline-primary btn-lg btn-block" href="<?php echo base_url('auth')?>">Login</a>
										</div>
									</div>
								</div>
							</form>
