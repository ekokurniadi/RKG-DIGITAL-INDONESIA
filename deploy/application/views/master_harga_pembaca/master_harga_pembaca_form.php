		...
		<div class="min-height-200px">
			...
			<div class="pd-20 card-box mb-30">
				...
				<form action="<?php echo $action; ?>" method="post" class="form-horizontal">
					...
					<input type="hidden" class="form-control" readonly name="kode_harga" id="kode_harga" placeholder="Kode Harga" value="<?php echo $kode_harga; ?>" />

					<div class="form-group row">
						<label class="col-sm-12 col-md-2 col-form-label">Kode <?php echo form_error('kode') ?></label>
						<div class="col-sm-12 col-md-10">
							<input type="text" class="form-control" name="kode" id="kode" placeholder="Kode Harga" value="<?php echo $kode; ?>" />
						</div>
					</div>
