  ...
  <div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
      ...
      <div class="card-box mb-30">
        <div class="pd-20">
          <h4 class="text-dark h4"><i class="icon-copy dw dw-newspaper"></i> Client</h4>
          <!-- <?php echo anchor(site_url('users/create'), '<i class="icon-copy dw dw-add-file-1"></i> Add New', 'class="btn btn-primary"'); ?> -->
        </div>
        <div class="pb-20">
            ...
            <script>
              $(document).ready(function() {
                dataTable = $('#example1').DataTable({
                  ...
                  "ajax": {
                    url: "<?php echo site_url('users/fetch_data'); ?>",
                    type: "POST",
                    dataSrc: "data",
                    data: function(d) {
                      return d;
