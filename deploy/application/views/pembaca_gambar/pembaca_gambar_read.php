    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Form Pembaca Gambar </h4>
                        <p class="mb-30"></p>
                    </div>
                </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Sip <?php echo form_error('sip') ?></label>
                          <div class="col-sm-12 col-md-10">
                            <input type="text" class="form-control" readonly name="sip" id="sip" placeholder="Sip" value="<?php echo $sip; ?>" />
                          </div>
                    </div>
	    ...
	    <a href="<?php echo site_url('pembaca_gambar') ?>" class="btn btn-icon icon-left btn-success">Cancel</a>
