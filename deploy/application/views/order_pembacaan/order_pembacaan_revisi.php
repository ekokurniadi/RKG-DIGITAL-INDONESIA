                                    ...
                                    if ($_SESSION['level'] != "Client") { ?>
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" v-if="mode=='update'|| mode=='create'" colspan="4">
                                                    <button @click.prevent="addDetail" type="button" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus"></i> Tambahkan </button>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    <?php } ?>
